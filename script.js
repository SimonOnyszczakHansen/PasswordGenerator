document.addEventListener("DOMContentLoaded", function () {
  ...
  const languages = {
      en: {
          ...
          tagsUsed: "Tags Used", // Added this line
      },
      da: {
          ...
          tagsUsed: "Brugte Tags", // Added this line
      },
  };
  ...
  function generateAndDisplayServicePasswords(basePassword) {
      ...
      passwordsContainer.innerHTML = passwords
          .map((entry, index) => {
              ...
              const specialCharacterIndex = entry.password.search(/[!@#$%&*()_+\]<€^]/);
              ...
              <div id="password-${index}" class="password-item">
                  ...
                  <span class="password-text">
                      <span class="tag-password">${escapeHTML(basePart)}</span><span class="service-password">${escapeHTML(servicePart)}</span>${escapeHTML(remainingPassword)}
                  </span>
